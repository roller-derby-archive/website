...
class ImageConverter
{
    ...
    /** @var array */
    private array $constImageFormat = [
        IMAGETYPE_GIF => 'gif',
        IMAGETYPE_JPEG => 'jpeg',
        IMAGETYPE_PNG => 'png',
        IMAGETYPE_WEBP => 'webp',
     ...
     */
    public function convert($from, $to, $quality = null): ?bool
    {
    ...
    private function saveImage($to, $image, $quality): ?bool
    {
     ...
     */
    private function getRealExtension($path): false|int
    {
     ...
     * @return void
     */
    private function makeDirectory($to): void
    {
 ...
 * @return bool|null
 */
function convert(string $from, string $to, $quality = null): ?bool
{
